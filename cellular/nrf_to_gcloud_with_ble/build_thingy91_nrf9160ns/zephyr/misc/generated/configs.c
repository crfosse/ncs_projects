...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LINK_CONTROL_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_HOST_UART_0, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_HOST_UART, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATE_TIME_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATE_TIME_LOG_LEVEL, 4);
