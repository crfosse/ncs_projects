...
#define GCLOUD_TOPIC "/devices/"
#define GCLOUD_TOPIC_LEN (sizeof(GCLOUD_TOPIC))

#define GCLOUD_CONFIG_TOPIC GCLOUD_TOPIC CONFIG_GCLOUD_DEVICE_NAME "/config"
#define GLCOUD_CONFIG_TOPIC_LEN (GCLOUD_TOPIC_LEN + CONFIG_GCLOUD_CLIENT_ID_MAX_LEN + 8)

#define GCLOUD_STATE_TOPIC GCLOUD_TOPIC CONFIG_GCLOUD_DEVICE_NAME "/state"
#define GLCOUD_STTE_TOPIC_LEN (GCLOUD_TOPIC_LEN + CONFIG_GCLOUD_CLIENT_ID_MAX_LEN + 7)

#define GCLOUD_TOPIC GCLOUD_TOPIC CONFIG_GCLOUD_DEVICE_NAME "/events"
#define GLCOUD_EVENTS_TOPIC_LEN (GCLOUD_TOPIC_LEN + CONFIG_GCLOUD_CLIENT_ID_MAX_LEN + 8)

LOG_MODULE_REGISTER(gcloud, CONFIG_GCLOUD_LOG_LEVEL);
...
#if !defined(CONFIG_GCLOUD_CLIENT_ID_APP)
BUILD_ASSERT(CONFIG_GCLOUD_CLIENT_ID_MAX_LEN >=
	     sizeof(CONFIG_GCLOUD_CLIENT_ID_STATIC) - 1,
...
#if defined(CONFIG_GCLOUD_IPV6)
#define GCLOUD_FAMILY AF_INET6
#else
#define GCLOUD_FAMILY AF_INET
#endif
...
static struct gcloud_app_topic_data app_topic_data;
static struct mqtt_client client;
static struct sockaddr_storage broker;

static char rx_buffer[CONFIG_GCLOUD_MQTT_RX_TX_BUFFER_LEN];
static char tx_buffer[CONFIG_GCLOUD_MQTT_RX_TX_BUFFER_LEN];
static char payload_buf[CONFIG_GCLOUD_MQTT_PAYLOAD_BUFFER_LEN];
...
static struct gcloud_suback_confirmation {
